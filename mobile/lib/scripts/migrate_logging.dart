...
void main() {
  Log.info('Logging Migration Helper',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info(
  ...
  Log.info('Pattern Analysis:',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('ERROR level for: Errors, failures, exceptions',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('WARNING level for: Warnings, retries, connection issues',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('INFO level for: Important state changes, completions',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('DEBUG level for: Operational details, processing steps',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('VERBOSE level for: Detailed parameters, trace information',
      name: 'MigrateLogging', category: LogCategory.system);

  Log.info('Migration steps:',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info("1. Add import: import '../utils/unified_logger.dart';",
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('2. Replace debugPrint based on content:',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info(
  ...
  Log.info('3. For simple migrations without changing level:',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('   - debugPrint(message) → Log.print(message)',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('', name: 'MigrateLogging', category: LogCategory.system);
  Log.info('4. Configure log level at app startup:',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('   - Development: UnifiedLogger.setLogLevel(LogLevel.debug)',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('   - Production: UnifiedLogger.setLogLevel(LogLevel.info)',
      name: 'MigrateLogging', category: LogCategory.system);
  Log.info('   - Debugging issues: UnifiedLogger.setLogLevel(LogLevel.verbose)',
      name: 'MigrateLogging', category: LogCategory.system);
}
