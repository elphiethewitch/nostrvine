...
class ReadyEventData {
  ...
  factory ReadyEventData.fromJson(Map<String, dynamic> json) => ReadyEventData(
  ...
  List<String>? get fileSizeTag =>
      fileSize != null ? ['size', fileSize.toString()] : null;
  ...
  List<String>? get thumbnailTag =>
      thumbnailUrl != null ? ['thumb', thumbnailUrl!] : null;
  ...
  int get estimatedEventSize {
    ...
    return content.length +
        tagsJson.length +
        200; // Add overhead for other fields
  }

  @override
  String toString() =>
      'ReadyEventData{publicId: $publicId, secureUrl: ${secureUrl.substring(0, 30)}..., originalUploadId: $originalUploadId}';
