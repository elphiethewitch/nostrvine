...
void main() {
  ...
  group('Identity Switching Tests', () {
    ...
    test('Should save current identity before switching', () async {
      ...
      // Verify it was saved
      final savedIdentity =
          await keyStorageService.getIdentityKeyPair(initialNpub);
    ...
    test('Should switch between saved identities', () async {
      ...
      final switchResult =
          await keyStorageService.switchToIdentity(identity2.npub);
      ...
      final switchBackResult =
          await keyStorageService.switchToIdentity(identity1.npub);
    ...
    test('Should not lose identities after app restart', () async {
      ...
      final savedIdentity1 =
          await newKeyStorageService.getIdentityKeyPair(identity1.npub);
      final savedIdentity2 =
          await newKeyStorageService.getIdentityKeyPair(identity2.npub);
    ...
    test('Should maintain key security during switching', () async {
      ...
      final privateKeyForSigning =
          await keyStorageService.getPrivateKeyForSigning();
