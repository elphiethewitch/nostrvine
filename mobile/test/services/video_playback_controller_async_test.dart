...
VideoEvent createMockVideoEvent() => VideoEvent(
      id: 'test_video_id',
      pubkey: 'test_pubkey',
...
void main() {
  ...
  group('VideoPlaybackController Async Patterns', () {
    ...
    group('Configuration Tests', () {
      test('should work with different retry configurations', () {
        const customConfig = VideoPlaybackConfig(
          maxRetries: 5,
        ...
        expect(customController.config.retryDelay,
  ...
  group('Performance Comparison', () {
    test('should demonstrate improved retry timing vs fixed delays', () async {
      ...
      Future<void> oldRetryPattern() async {
      ...
      Future<void> newRetryPattern() async {
