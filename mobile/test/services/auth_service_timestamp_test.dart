...
void main() {
  group('AuthService Event Creation', () {
    test('should create Kind 0 event with 5-minute backdated timestamp',
        () async {
    ...
    test('should create Kind 22 event with 30-second backdated timestamp',
        () async {
      final currentTime = DateTime.now().toUtc().millisecondsSinceEpoch ~/ 1000;
      final kind22Tolerance = NostrTimestamp.getDriftToleranceForKind(22);
      final kind22Timestamp =
          NostrTimestamp.now(driftTolerance: kind22Tolerance);
