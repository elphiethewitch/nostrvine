...
void main() {
  testWidgets('Camera initialization should complete within 2 seconds without hanging',
    ...
    expect(
      ...
      isTrue,
      reason: 'Camera should initialize or show error within $initializationTimeout, '
    ...
    expect(
      ...
      reason: 'Should not be stuck in processing state after initialization timeout',
    );
  });
