...
void main() {
  group('Original Content Badge Tests (TDD)', () {
    testWidgets('OriginalContentBadge renders with correct styling', (WidgetTester tester) async {
      // Arrange & Act
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: OriginalContentBadge(size: BadgeSize.medium),
          ),
        ),
      );
    ...
    test('VideoEvent.shouldShowOriginalBadge returns true for original user content', () {
    ...
    test('VideoEvent.shouldShowOriginalBadge returns false for vintage vines', () {
    ...
    testWidgets('ProofModeBadgeRow shows OriginalContentBadge for original user content',
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: ProofModeBadgeRow(video: videoEvent),
          ),
        ),
      );
    ...
    testWidgets('ProofModeBadgeRow does NOT show OriginalContentBadge for reposts',
        (WidgetTester tester) async {
    ...
    testWidgets('ProofModeBadgeRow does NOT show OriginalContentBadge for vintage vines',
        (WidgetTester tester) async {
