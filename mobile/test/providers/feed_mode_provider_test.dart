...
void main() {
  group('FeedModeProvider', () {
    ...
    test('should switch to different modes', () {
      ...
      expect(
          container.read(feedModeNotifierProvider), equals(FeedMode.curated));

      notifier.setMode(FeedMode.discovery);
      expect(
          container.read(feedModeNotifierProvider), equals(FeedMode.discovery));

      notifier.showFollowing();
      expect(
          container.read(feedModeNotifierProvider), equals(FeedMode.following));
    });
    ...
    test('should set hashtag mode with context', () {
      ...
      expect(
          container.read(feedModeNotifierProvider), equals(FeedMode.hashtag));
    ...
    test('should set profile mode with pubkey', () {
      ...
      expect(
          container.read(feedModeNotifierProvider), equals(FeedMode.profile));
