...
void main() {
  group('RelaySettingsScreen', () {
    ...
    testWidgets('displays relay settings screen with app bar', (tester) async {
    ...
    testWidgets('displays list of relays with their status', (tester) async {
      ...
      expect(
          find.byType(CircularProgressIndicator), findsOneWidget); // Connecting
    });

    testWidgets('allows adding a new relay', (tester) async {
    ...
    testWidgets('validates relay URL format', (tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('allows removing a relay', (tester) async {
    ...
    testWidgets('refreshes relay statuses on pull to refresh', (tester) async {
    ...
    testWidgets('displays help text about relay connectivity', (tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('handles duplicate relay addition', (tester) async {
      await tester.pumpWidget(createTestWidget());
